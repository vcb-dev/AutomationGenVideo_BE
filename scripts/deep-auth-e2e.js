...
async function runFullE2ETest() {
  console.log('================================================================');
  console.log('🔬 DEEP AUTH NETWORK & APPLICATION DIAGNOSTIC TEST SUITE (E2E)');
  console.log('================================================================\n');
  ...
  console.log(`✓ NestJS Live Test Instance running on http://localhost:${TEST_PORT}/api\n`);
  ...
  try {
    ...
    // Activate user via UsersService (simulating Admin approval with cache invalidation)
    const usersService = app.get(require('../dist/modules/users/users.service').UsersService);
    await usersService.update(testUserId, { is_active: true });
    console.log('✓ Admin activated user in DB & invalidated cache (is_active: true)');
