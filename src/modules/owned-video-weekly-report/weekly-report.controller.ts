 ...
 *
 * `run-thu` tồn tại để nghiệm thu: dựng message trên dữ liệu THẬT rồi trả về đọc, mà không nhắn
 * ai. Không có nó thì cách duy nhất để biết message trông thế nào là bắn thật vào mặt người nhận.
 */
...
export class WeeklyReportController {
  ...
  /** Dựng message và trả về, KHÔNG gửi, KHÔNG ghi nhật ký. */
  @Post('run-thu')
  async runTest() {
