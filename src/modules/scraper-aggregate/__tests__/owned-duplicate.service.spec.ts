...
describe('buildDuplicateAlerts — chỉ cảnh báo cấp KÊNH', () => {
   ...
   * ra ngoài. Thêm nữa ChannelAlert vẽ avatar + tên kênh, mà một nhóm nội dung phủ 4 kênh
