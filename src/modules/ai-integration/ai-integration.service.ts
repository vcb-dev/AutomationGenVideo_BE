...
export class AiIntegrationService {
  ...
  /**
   * Tổng quan số lượt chuyển đổi content của TẤT CẢ thành viên trong phạm vi quyền của người gọi
   * — để tab "Thống kê" hiện dữ liệu ngay khi mở, không phải chọn từng người qua dropdown.
   *
   ...
   * thành viên" đang dùng, nên hai phần luôn khớp nhau và không phát sinh cách xét quyền mới.
   */
  /**
