...
-- CreateIndex
CREATE UNIQUE INDEX "scraper_douyin_videos_shortcode_key" ON "scraper_douyin_videos"("shortcode");

-- CreateIndex
CREATE INDEX "scraper_douyin_videos_author_id_idx" ON "scraper_douyin_videos"("author_id");

-- CreateIndex
CREATE INDEX "scraper_douyin_videos_play_count_idx" ON "scraper_douyin_videos"("play_count" DESC);
